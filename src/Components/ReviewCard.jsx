...
function ReviewCard({img}) {
  return (
    ...
    <div id='reviewcard' className='w-[320px] h-[500px] border rounded-[20px] flex flex-col gap-[20px] p-5'>
        ...
        <h1 className='text-base text-[#112211] font-bold'>“A natural peace of community, for holidays”</h1>
        ...
        <div className='flex flex-col gap-4'>
            ...
            <span>
            <h1 className='text-[#112211] font-bold'>Areeb</h1>
            <p className='text-[12px] text-[#112211] font-medium'>SMIT – REACT</p>
            </span> 
